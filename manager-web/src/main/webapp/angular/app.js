...
lostAndFoundApp.config(function ($routeProvider) {
    $routeProvider.
            ...
            when('/users', {templateUrl: 'partials/userList.html', controller: 'userListCtrl'}).
 ...
 * Product detail page
 */
//controllers.controller('ProductDetailCtrl',
...
//controllers.controller('CategoryDetailCtrl', ['$scope', '$routeParams', '$http',
...
//    });
//}
//controllers.controller('AdminProductsCtrl',
//    function ($scope, $rootScope, $routeParams, $http) {
...
// */
//controllers.controller('AdminNewProductCtrl',
 ...
 * Admin categories
 */
//controllers.controller('AdminCategoriesCtrl',
//    function ($scope, $rootScope, $routeParams, $http) {
 ...
 */
//controllers.controller('AdminNewCategoryCtrl',
//    function ($scope, $routeParams, $http, $location, $rootScope) {
//        //set object bound to form fields
//        $scope.category = {
//            'name': ''
